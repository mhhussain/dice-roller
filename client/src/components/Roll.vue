<template>
    <el-card class="roll-card" shadow="hover">
        ...
        <div class="roll-view">
            <el-button type="success" icon="el-icon-view" circle v-if="!roll.visible && controlsVisible" @click="showRoll(roll._id)"></el-button>
            <el-button type="danger" icon="el-icon-view" circle v-if="roll.visible && controlsVisible" @click="hideRoll(roll._id)"></el-button>
        </div>
        <div class="roll-delete">
            <i class="el-icon-delete" v-if="controlsVisible" @click="deleteRoll(roll._id)"></i>
        </div>
    </el-card>
</template>
